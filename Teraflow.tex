...
\begin{figure}[h]
   ...
   \includegraphics[width=1\textwidth]{grpc.png}
    ...
    \label{fig:grpc}
\end{figure}
Google Remote Procedure Calls (gRPC) è un framework OpenSource sviluppato da Google per facilitare la comunicazione tra applicazioni distribuite. Permette di
...
%A differenza degli altri protocolli RPC la richiesta viene mandata a più di un server usando multicast o comunicazione point-to-point. 
