...
Ogni router all'interno dell'area conosce la topologia completa della rete e calcola i percorsi, indipendentemente dagli altri, utilizzando l'algoritmo di Dijkstra \cite{ospf}. 
